...
\begin{figure}[t!bh]
	\begin{center}
		\subfloat[]{\includegraphics[width=.5\linewidth]{figures/AnalysisStrategy/h_DR_qq_W_500GeV}\label{fig:dr_qq_a}}
		\subfloat[]{\includegraphics[width=.5\linewidth]{figures/AnalysisStrategy/h_DR_qq_W_1000GeV}\label{fig:dr_qq_b}}\\
		\subfloat[]{\includegraphics[width=.5\linewidth]{figures/AnalysisStrategy/h_DR_qq_W_2000GeV}\label{fig:dr_qq_c}}
		\subfloat[]{\includegraphics[width=.5\linewidth]{figures/AnalysisStrategy/h_DR_qq_W_5000GeV}\label{fig:dr_qq_d}}\\
