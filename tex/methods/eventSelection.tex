...
\begin{figure}[tbp]
\centering
\subfloat[]{\includegraphics[width=.49\textwidth]{figures/EventSelection/JM_5_comb_VBF}\label{fig:evt_sigbkg_hp:a}}
\subfloat[]{\includegraphics[width=.49\textwidth]{figures/EventSelection/JM_5_comb_ggF}\label{fig:evt_sigbkg_hp:b}}\\
