...
\input{tex/misc/acknowledgements.tex}
\cleardoublepage                     % allows next section to jump correctly
...
\input{tex/sec-appendix}
%\input{tex/sec-appendix}                         % appendices listed here
\cleardoublepage
